...
public class EyeDataClassifierFormat
{
    ...
    public EyeDataClassifierFormat(string tag, int trigger, int phase, string phaseName,int reachTarget, int lookTarget, string lookTargetName, int blink, bool blinking){
        this.tag = tag;
