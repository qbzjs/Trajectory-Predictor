...
public class ArmRig_IK : MonoBehaviour{
    ...
    void Start()
    {
        ...
        if (showLeftArm){
            leftArmParentReference.gameObject.SetActive(showLeftArm);
        }

        if (showRightArm){
            rightArmParentReference.gameObject.SetActive(showRightArm);
        }
    }
    ...
    private void ApplyArmReferences(){
        ...
        rightShoulder.rotation = new Quaternion(rightShoulderReference.rotation.x, rightShoulderReference.rotation.y, rightShoulderReference.rotation.z,rightShoulderReference.rotation.w);
        ...
        LS.position = new Vector3(leftShoulderReference.position.x, leftShoulderReference.position.y, leftShoulderReference.position.z);
        LS.rotation = new Quaternion(leftShoulderReference.rotation.x, leftShoulderReference.rotation.y, leftShoulderReference.rotation.z,leftShoulderReference.rotation.w);
        
        LE.position = new Vector3(leftElbowReference.position.x, leftElbowReference.position.y, leftElbowReference.position.z);
        LE.rotation = new Quaternion(leftElbowReference.rotation.x, leftElbowReference.rotation.y, leftElbowReference.rotation.z,leftElbowReference.rotation.w);
        
        LH.position = new Vector3(leftHandReference.position.x, leftHandReference.position.y, leftHandReference.position.z);
        LH.rotation = new Quaternion(leftHandReference.rotation.x, leftHandReference.rotation.y, leftHandReference.rotation.z,leftHandReference.rotation.w);
        
        RS.position = new Vector3(rightShoulderReference.position.x, rightShoulderReference.position.y, rightShoulderReference.position.z);
        RS.rotation = new Quaternion(rightShoulderReference.rotation.x, rightShoulderReference.rotation.y, rightShoulderReference.rotation.z,rightShoulderReference.rotation.w);
        
        RE.position = new Vector3(rightElbowReference.position.x, rightElbowReference.position.y, leftElbowReference.position.z);
        RE.rotation = new Quaternion(rightElbowReference.rotation.x, rightElbowReference.rotation.y, rightElbowReference.rotation.z,rightElbowReference.rotation.w);
        
        RH.position = new Vector3(rightHandReference.position.x, rightHandReference.position.y, rightHandReference.position.z);
        RH.rotation = new Quaternion(rightHandReference.rotation.x, rightHandReference.rotation.y, rightHandReference.rotation.z,rightHandReference.rotation.w);
    }
